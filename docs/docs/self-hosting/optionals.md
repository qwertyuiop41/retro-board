...
services:
  ...
  frontend:
    ...
    environment:
      # -- Optional --
      RETRO_GOOGLE_ANALYTICS_ID: '' # Optional, Google Analytics ID (UA-1234456-7)
      RETRO_GOOGLE_AD_WORDS_ID: '' # Optional, Google Adwords ID (AW-1234456)
      RETRO_GOOGLE_AD_WORDS_CONVERSION_ID: '' # Optional, Google Adwords Event ID (AW-1234456/1234456)
      RETRO_SENTRY_URL: '' # Optional, Sentry URL (https://1234567890abcdef12345@sentry.io/1234567)
      RETRO_GIPHY_API_KEY: '' # Optional, can be obtained here: https://developers.giphy.com/
      RETRO_DEFAULT_LANGUAGE: 'en-GB' # Set the default language for new users
      RETRO_MARKETING_ROOT: 'https://www.retrospected.com' # URL of the marketing website
      ...
      RETRO_STRIPE_KEY: '' # Stripe publishable key (for frontend)
