...
const config: BackendConfig = {
  ...
  OAUTH2_AUTHORIZATION_URL: defaults('OAUTH2_AUTHORIZATION_URL', ''),
  OAUTH2_TOKEN_URL: defaults('OAUTH2_TOKEN_URL', ''),
  OAUTH2_CLIENT_ID: defaults('OAUTH2_CLIENT_ID', ''),
  OAUTH2_CLIENT_SECRET: defaults('OAUTH2_CLIENT_SECRET', ''),
